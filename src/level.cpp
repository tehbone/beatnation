/**
 * @file Defines for the level class.
 */
#include <fstream>
#include "level.hpp"
...
void
Level::AddChar(Player *character)
{
	numChars++;
...
void
Level::initialize(char *filename, int width, int height)
{
	podium = NULL;
	minorstate = 0;
	physicsSpaces = NULL;
...
void
Level::respawn(Player *p, bool death)
{
	int i;
	bool entered = false;
